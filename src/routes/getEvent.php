...
$app->post('/api/GettyImages/getEvent', function ($request, $response) {
    ...
    $requiredParams = ['apiKey'=>'apiKey','eventId'=>'id'];
    ...
    $query_str = "https://api.gettyimages.com/v3/events/{$data['id']}";
