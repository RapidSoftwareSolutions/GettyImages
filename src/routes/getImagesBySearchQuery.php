...
$app->post('/api/GettyImages/getImagesBySearchQuery', function ($request, $response) {
    ...
    $query_str = "https://api.gettyimages.com/v3/search/images";
