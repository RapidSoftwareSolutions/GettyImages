...
$app->post('/api/GettyImages/getVideos', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['apiKey','videoIds']);
    ...
    $requiredParams = ['apiKey'=>'apiKey','videoIds'=>'ids'];
    $optionalParams = ['acceptLanguage'=>'acceptLanguage','accessToken'=>'accessToken','fields'=>'fields'];
    $bodyParams = [
       'query' => ['fields','ids']
    ];
    ...
    $query_str = "https://api.gettyimages.com/v3/videos";
