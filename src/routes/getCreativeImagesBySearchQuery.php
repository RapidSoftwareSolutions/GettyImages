...
$app->post('/api/GettyImages/getCreativeImagesBySearchQuery', function ($request, $response) {
    ...
    $optionalParams = ['acceptLanguage'=>'acceptLanguage','accessToken'=>'accessToken','ageOfPeople'=>'age_of_people','artists'=>'artists','collectionCodes'=>'collection_codes','collectionsFilterType'=>'collections_filter_type','color'=>'color','compositions'=>'compositions','embedContentOnly'=>'embed_content_only','ethnicity'=>'ethnicity','excludeNudity'=>'exclude_nudity','fields'=>'fields','fileTypes'=>'file_types','graphicalStyles'=>'graphical_styles','keywordIds'=>'keyword_ids','licenseModels'=>'license_models','minimumSize'=>'minimum_size','numberOfPeople'=>'number_of_people','orientations'=>'orientations','phrase'=>'phrase','prestigeContentOnly'=>'prestige_content_only','productTypes'=>'product_types','page'=>'page','pageSize'=>'page_size','sortOrder'=>'sort_order'];
    $bodyParams = [
       'query' => ['age_of_people','artists','collection_codes','collections_filter_type','color','compositions','embed_content_only','ethnicity','exclude_nudity','fields','file_types','graphical_styles','keyword_ids','license_models','minimum_size','number_of_people','orientations','phrase','prestige_content_only','product_types','page','page_size','sort_order']
    ];
    ...
    $query_str = "https://api.gettyimages.com/v3/search/images/creative";
