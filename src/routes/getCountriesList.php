...
$app->post('/api/GettyImages/getCountriesList', function ($request, $response) {
    ...
    $optionalParams = ['accessToken'=>'accessToken','acceptLanguage'=>'acceptLanguage'];
    $bodyParams = [
    ];
    ...
    $query_str = "https://api.gettyimages.com/v3/countries";
