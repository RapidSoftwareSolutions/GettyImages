...
$app->post('/api/GettyImages/getVideoBySearchQuery', function ($request, $response) {
    ...
    $query_str = "https://api.gettyimages.com/v3/search/videos";
