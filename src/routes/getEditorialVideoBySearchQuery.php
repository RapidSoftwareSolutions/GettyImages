...
$app->post('/api/GettyImages/getEditorialVideoBySearchQuery', function ($request, $response) {
    ...
    $optionalParams = ['acceptLanguage'=>'acceptLanguage','accessToken'=>'accessToken','ageOfPeople'=>'age_of_people','collectionCodes'=>'collection_codes','collectionsFilterType'=>'collections_filter_type','excludeNudity'=>'exclude_nudity','fields'=>'fields','keywordIds'=>'keyword_ids','licenseModels'=>'license_models','phrase'=>'phrase','productTypes'=>'product_types','specificPeople'=>'specific_people','formatAvailable'=>'format_available','page'=>'page','pageSize'=>'page_size','sortOrder'=>'sort_order','specificPeople'=>'specific_people','entityUris'=>'entity_uris'];
    $bodyParams = [
       'query' => ['minimum_quality_rank','specific_people','editorial_segments','format_available','entity_uris','age_of_people','artists','collection_codes','collections_filter_type','color','compositions','embed_content_only','ethnicity','exclude_nudity','fields','file_types','graphical_styles','keyword_ids','license_models','minimum_size','number_of_people','orientations','phrase','prestige_content_only','product_types','page','page_size','sort_order']
    ];
    ...
    $query_str = "https://api.gettyimages.com/v3/search/videos/editorial";
