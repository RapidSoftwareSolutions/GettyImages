...
$app->post('/api/GettyImages/getCreativeVideoBySearchQuery', function ($request, $response) {
    ...
    $query_str = "https://api.gettyimages.com/v3/search/videos/creative";
